        ...
        <div class="main_banner_section">
                <div class="banner_box">
                    <div  class="banner_img_box">
                        <h3 class="main_heading_title">Favourites</h3>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 col-12 mb-4">
                        <div class="card_box">
                            ...
                            <div class="card_content">
                                ...
                                <a href="{{ route('sub_categories', [$music->main_category->super_category->slug_name, $music->main_category->slug_name, $music->slug_name]) }}">
