...
@section('content')
    <div class="container px-0">
        <h2 class="text-21 fw-bold mb-4">Create Plans</h2>
        <div class="profile px-0 pt-0">
            <div class="content-box">
                <form id="add_plan_form" method="post" action="{{ route('plans.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="row porfile-form pt-4">
                        <div class="form-group col-lg-6 col-md-6 mb-4">
                            ...
                            <input type="text" placeholder="Package Name" class="w-100 text-16 textdark px-4 py-3" name="name" id="name" value="{{ old('name') }}" maxlength="150" required>
                            @error('name')
                        ...
                        <div class="form-group col-lg-6 col-md-6 mb-4">
                            ...
                            <input type="number" placeholder="Days" class="w-100 text-16 textdark px-4 py-3" name="days" id="days" min="1" value="{{ old('days') }}" required>
                            @error('days')
                                <p class="text-danger">{{ $message }}</p>
                            @enderror
                        </div>
                        <div class="form-group col-lg-6 col-md-6 mb-4">
                            ...
                            <input type="number" placeholder="₹" class="w-100 text-16 textdark px-4 py-3" name="cost" id="cost" min="1" value="{{ old('cost') }}" required>
                            @error('cost')
                                <p class="text-danger">{{ $message }}</p>
                            @enderror
                        </div>
                        <div class="form-group col-lg-6 col-md-6 mb-4">
                            ...
                            <input type="number" placeholder="$" class="w-100 text-16 textdark px-4 py-3" name="cost_usd" id="cost_usd" min="1" value="{{ old('cost_usd') }}" required>
                            @error('cost_usd')
                                <p class="text-danger">{{ $message }}</p>
                            @enderror
                        </div>
                        <div class="form-group col-lg-6 col-md-6 mb-4">
                            ...
                            <input type="number" placeholder="€" class="w-100 text-16 textdark px-4 py-3" name="cost_euro" id="cost_euro" min="1" value="{{ old('cost_euro') }}" required>
                            @error('cost_euro')
                                <p class="text-danger">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="cetificate-btns col-12">
                            <button type="submit" id="submitBtn"class="save-btn text-22 my-md-3 mx-1 anim">Save</button></a>
