    ...
    <div class="container px-0">
        <div class="Business-profile">
            <div class="d-flex flex-wrap align-items-center justify-content-sm-between justify-content-center gap-3 mx-2 px-2 mx-1">
                <h2 class="d-block text-21 fw-bold offer-title text-capitalize">Setting Management</h2>
                 {{-- @can('setting-create') --}}
                   {{-- <a href="{{ route('setting.create') }}" class="add-btn">Add Setting</a> --}}
                {{-- @endcan --}}
            </div>
            <div class="dashboard-table pt-3">
                <div class="table_plan-holder">
                    <div class="">
                        <table class="mb-0 data-table" id="setting-list">
                            <thead>
                                <tr>
                                    ...
                                    <th width="2%"  class="bg-white border-black whitespace-nowrap p-0">
                                        <span class="border-0 text-18 d-block text-center offer-box">Key</span>
                                    </th>
                                    <th width="2%"  class="bg-white border-black whitespace-nowrap p-0">
                                        <span class="border-0 text-18 d-block text-center offer-box">Value</span>
                                    </th>
                                    <th width="2%"  class="bg-white border-black whitespace-nowrap p-0">
...
@section('js')
    <script type="text/javascript">
        $(document).ready(function() {
            var table = $('#setting-list').DataTable({
                responsive: true,
                scrollX: true,
                language: {
                    "sSearch": "",
