    ...
    <div class="container px-0">
        <div class="Business-profile">
            <div class="d-flex flex-wrap align-items-center justify-content-sm-between justify-content-center gap-3 px-2 mx-1">
                <h2 class="d-block text-21 fw-bold offer-title text-capitalize">photos Management</h2>
                 @can('gallary-create')
                   <a href="{{ route('photos.create') }}" class="add-btn">Add Photo</a>
                @endcan
            </div>
            <div class="dashboard-table pt-3">
                <div class="table_plan-holder">
                    <div class="">
                        <table class="mb-0 data-table" id="photos-list">
                            <thead>
                                <tr>
...
@section('js')
    <script type="text/javascript">
        $(document).ready(function() {
            var table = $('#photos-list').DataTable({
                responsive: true,
                scrollX: true,
                searching: false,
                language: {
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            ...
                            success: function (response) {
                                ...
                                $('#about-list').DataTable().ajax.reload(null, false);  
                            },
