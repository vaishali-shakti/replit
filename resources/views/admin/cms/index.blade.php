    ...
    <div class="container px-0">
        <div class="Business-profile">
            <div class="d-flex flex-wrap align-items-center justify-content-sm-between justify-content-center gap-3 px-2 mx-1">
                <h2 class="d-block text-21 fw-bold offer-title text-capitalize">CMS Management</h2>
                 @can('subcategory-create')
                   <a href="{{ route('cms.create') }}" class="add-btn">Add CMS</a>
                @endcan
            </div>
            <div class="dashboard-table pt-3">
                <div class="table_plan-holder">
                    <div class="">
                        <table class="mb-0 data-table" id="cms-list">
                            <thead>
                                <tr>
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            ...
                            success: function (response) {
                                ...
                                $('#cms-list').DataTable().ajax.reload(null, false);  
                            },
