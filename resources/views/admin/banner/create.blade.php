...
@section('content')
    <div class="container px-0">
        <h2 class="text-21 fw-bold mb-4">Create Banner</h2>
        <div class="profile px-0 pt-0">
            <div class="content-box">
                <form id="create_banner_form" method="post" action="{{ route('banner.store') }}"
                    ...
                    <div class="row porfile-form pt-4">
                        <div class="form-group col-lg-12 col-md-12 mb-4">
                            ...
                            <input type="text" placeholder="Title" class="w-100 text-16 textdark px-4 py-3" name="title" maxlength ="100" id="title" value="">
                            @error('title')
