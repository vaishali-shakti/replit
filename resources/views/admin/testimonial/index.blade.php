    ...
    <div class="container px-0">
        <div class="Business-profile">
            <div class="d-flex flex-wrap align-items-center justify-content-sm-between justify-content-center gap-3 px-2 mx-1">
                <h2 class="d-block text-21 fw-bold offer-title text-capitalize">Testimonial Management</h2>
                 {{-- @can('testimonial-create')
                   <a href="{{ route('testimonial.create') }}" class="add-btn">Add Testimonial</a>
                @endcan --}}
            </div>
            <div class="dashboard-table pt-3">
                <div class="table_plan-holder">
                    <div class="">
                        <table class="mb-0 data-table" id="testimonial-list">
                            <thead>
                                <tr>
                                    <th width="50%"  class="bg-white border-black whitespace-nowrap p-0">
                        ...
                        $.ajax({
                            ...
                            success: function (response) {
                                if (response.status === 1) {
                                    ...
                                    Swal.fire(
                                        'Error!',
                                        'There was an issue deleting the Testimonial.',
                                        'error'
                                    );
                                }
                                $('#testimonial-list').DataTable().ajax.reload(null, false);  
                            },
