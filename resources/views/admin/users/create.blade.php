...
@section('content')
    <div class="container px-0">
        <h2 class="text-21 fw-bold mb-4">Create User</h2>
                ...
                <form id="create_user_form" method="post" action="{{ route('users.store') }}"
                    ...
                    <div class="row porfile-form pt-4">
                        ...
                        <div class="form-group col-lg-6 col-md-12 mb-4">
                            ...
                            <input type="text" placeholder="YYYY/MM/DD" class="w-100 text-16 textdark px-4 py-3" name="dob" id="dob" value="{{ old('dob') }}" required>
                            @error('dob')
                                <p class="text-danger">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="form-group col-lg-6 col-md-12 mb-4">
                            ...
                            <input type="time" placeholder="Time of birth(AM/PM)" class="w-100 text-16 textdark px-4 py-3" name="time_of_birth" id="time_of_birth" value="{{ old('time_of_birth') }}">
                            @error('time_of_birth')
                                <p class="text-danger">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="form-group col-lg-6 col-md-12 mb-4">
                            ...
                            <input type="text" placeholder="Place of birth" class="w-100 text-16 textdark px-4 py-3" maxlength="100"  name="place_of_birth" id="place_of_birth" value="{{ old('place_of_birth') }}">
                        ...
                        <div class="form-group col-lg-6 col-md-12 mb-4">
                            ...
                            <input type="text" placeholder="Mobile No. 1" class="w-100 text-16 textdark py-3" name="mobile_number_1" maxlength="10" minlength="10" id="mobile_number_1" value="{{ old('mobile_number_1') }}" pattern="[0-9]+" required>
                        ...
                        <div class="form-group col-lg-6 col-md-12 mb-4">
                            ...
                            <input type="text" placeholder="Mobile No. 2" class="w-100 text-16 textdark py-3" name="mobile_number_2" maxlength="10" minlength="10" id="mobile_number_2" value="{{ old('mobile_number_2') }}" style="padding-left: 85px;" pattern="[0-9]+">
                        ...
                        <div class="form-group col-lg-6 col-md-12 mb-4">
                            ...
                            <input type="email" placeholder="Email" class="w-100 text-16 textdark px-4 py-3" name="email" id="email" value="{{ old('email') }}" required>
                        ...
                        <div class="form-group col-lg-12 col-md-12 mb-4">
                            ...
                            <input type="text" placeholder="Your discomfort" class="w-100 text-16 textdark px-4 py-3" maxlength="150" name="discomfort"  id="discomfort" value="{{ old('discomfort') }}">
                            @error('discomfort')
                                <p class="text-danger">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="form-group col-lg-6 col-md-12 mb-4">
                            ...
                            <div class="d-flex position-relative">
                                 <input type="password" placeholder="Password" class="w-100 text-16 textdark px-4 py-3" name="password" minlength="6" id="password" value="{{ old('password') }}" required>
                        ...
                        <div class="form-group col-lg-6 col-md-12 mb-4">
                            ...
                            <div  class="d-flex position-relative">
                                <input type="password" placeholder="Confirm Password" class="w-100 text-16 textdark px-4 py-3" minlength="6" name="conpassword" id="conpassword" value="{{ old('conpassword') }}" required>
                        ...
                        <div class="form-group porfile-form col-lg-12 col-md-12 mb-4 user_limit hidden">
                        ...
                        <div class="form-group porfile-form col-lg-12 col-md-12 mb-4 custom_user hidden">
                            <label for="frequency" class="d-block text-18 fw-bold pb-2">Assign Frequencies<span class="text-danger">*</span></label>
                            <select name="frequency[]" id="frequency" class="w-100 text-16 textdark px-4" required multiple>
                                <option value="all">All</option>
                                @foreach($sub_category as $sub_cat)
                                    <option value="{{ $sub_cat->id }}">{{ $sub_cat->name .' ('.$sub_cat->main_category->name.')'}}</option>
                                @endforeach
                            </select>
                            @error('frequency')
                                <p class="text-danger">{{ $message }}</p>
                        ...
                        <!-- Start Date -->
                        <div class="form-group col-lg-6 col-md-12 mb-4 custom_user user_limit hidden">
                            <label for="" class="d-block text-18 fw-bold pb-2">Start Date<span class="text-danger">*</span></label>
                            <div class="d-flex position-relative">
                                 <input type="date" placeholder="Start Date" class="w-100 text-16 textdark px-4 py-3" name="start_date" id="start_date" minlength="6" value="{{ old('start_date') }}" required>
                            </div>
                            @error('start_date')
                                <p class="text-danger">{{ $message }}</p>
                             @enderror
                        ...
                        <div class="form-group col-lg-6 col-md-12 mb-4 custom_user user_limit hidden">
                            ...
                            <div class="d-flex position-relative">
                                 <input type="date" placeholder="End Date" class="w-100 text-16 textdark px-4 py-3" name="end_date" id="end_date" minlength="6" value="{{ old('end_date') }}" required>
                            </div>
                            @error('end_date')
                                <p class="text-danger">{{ $message }}</p>
                             @enderror
                        ...
                        {{-- User Limit --}}
                        <div class="form-group col-lg-6 col-md-6 mb-4 user_limit hidden">
                            <label for="" class="d-block text-18 fw-bold pb-2">User Limit</label>
                            <input type="number" placeholder="User Limit" class="w-100 text-16 textdark px-4 py-3" name="user_limit" id="user_limit" min="1" max="999999999" value="{{ old('user_limit') }}">
                            @error('user_limit')
                                <p class="text-danger">{{ $message }}</p>
                            @enderror
                        </div>
    ...
    @section('js')
        <script>
            ...
            $(document).ready(function() {
                ...
                $('#new_Password, #confirmePassword').click(function () {
